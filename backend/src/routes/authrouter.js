...
const routes = (app) => {
  app.post("/api/v1/auth/signup", authMiddleware.validateSignupRequest, authController.signup);

  app.post("/api/v1/auth/signin", authMiddleware.validateSigninRequest, authController.signin);
